...
<body>
<h4>Appointments for <?= Html::encode($patient['username']) ?></h4>
...
<div class="tab-content mt-3">
  <div class="tab-pane fade show active" id="today" role="tabpanel">
    <?= $this->render('_appointments_table', ['appointments' => $todays, 'doctorNames' => $doctorNames]) ?>
  </div>
  <div class="tab-pane fade" id="past" role="tabpanel">
    <?= $this->render('_appointments_table', ['appointments' => $past, 'doctorNames' => $doctorNames]) ?>
  </div>
  <div class="tab-pane fade" id="future" role="tabpanel">
    <?= $this->render('_appointments_table', ['appointments' => $future, 'doctorNames' => $doctorNames]) ?>
  </div>
</div>
